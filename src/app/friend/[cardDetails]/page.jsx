...
const CardDetails = async ({ params }) => {
    ...
    const res = await fetch(
        "https://keen-keeper-teal.vercel.app/friends.json",
        { cache: "no-store" }
    );
    ...
    return (
        <div className="w-full">
            {card ? (
                <div className="max-w-6xl mx-auto mt-5 px-4 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
                        ...
                        <div className="lg:col-span-2 w-full">
                            <div className="w-full shadow-md bg-white rounded-xl py-4 px-4 flex flex-col items-center text-center gap-3">
                                ...
                                <div className="flex flex-wrap justify-center gap-2 mt-2">
                                    {card.tags.map((tag, ind) => (
                                        <div
                                            key={ind}
                                            className="badge bg-[#CBFADB] px-3 py-2 text-[#244D3F] font-semibold"
                                        >
                                            {tag}
                                        </div>
                                    ))}
                            ...
                            <div className="mt-5 space-y-2 w-full">
                                <button className="btn w-full bg-white flex items-center justify-center gap-2 font-bold">
                                ...
                                <button className="btn w-full bg-white flex items-center justify-center gap-2 font-bold text-red-600">
                                    <RiDeleteBin6Line />
                                    Delete
                                </button>
                            </div>
                        ...
                        <div className="lg:col-span-3 rounded-xl space-y-5 w-full">

                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div className="shadow-md rounded-xl text-center py-8 bg-white">
                            ...
                            <div className="shadow-md rounded-lg px-4 py-8 bg-white relative">
                                <button className="btn btn-sm bg-white float-right">
                                    Edit
                                </button>

                                <h3 className="font-bold text-xl text-[#244D3F]">
                                    Relationship Goal
                                </h3>
                            ...
                            <div className="shadow-md p-5 rounded-lg bg-white py-12">
                                <h1 className="text-[#244D3F] mb-3 font-bold text-xl">
                                    Quick Check-In
                                </h1>
                ...
                <div className="text-red-400 text-center font-bold text-3xl py-40">
                    Error occurred while fetching friend data. Please try again later.
                </div>
            )}
        </div>
    );
